...
export default function CoirCategoryPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const res = await fetch(`/api/coir-products?category=${slug}`);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-700">
              Eco-friendly and sustainable handcrafted products
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {products.map((p) => {
                ...
                return (
                  ...
                  >
                    {/* IMAGE - Clickable */}
                    <Link href={`/creativeAndHandcrafted/coir-products/product/${p.id}`} className="block">
                    ...
                    {/* TITLE - Clickable */}
                    <Link href={`/creativeAndHandcrafted/coir-products/product/${p.id}`}>
