...
import { Heart, Mail, ShoppingBag, Flower2, Leaf } from "lucide-react";
...
export default function CoirProductsPage() {
  const categories: Category[] = [
    {
      id: 1,
      title: "All Coir Products",
      slug: "all-coir",
      icon: <Leaf className="w-12 h-12" />,
      color: "text-green-700",
      bgColor: "bg-gradient-to-br from-green-50 to-emerald-100",
      description: "Browse our complete collection of eco-friendly coir products",
    },
    {
      id: 2,
      title: "Dry Flowers",
      ...
      description: "Beautiful preserved flowers for decoration and crafts",
    },
  ];
        ...
        <section className="relative py-20 px-6 bg-gradient-to-br from-[#fdfaf6] via-[#f5f1e8] to-[#eadbc4]/40">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto leading-relaxed">
              Discover our eco-friendly collection of natural coir products and preserved flowers
            </p>
          </div>
        </section>
        ...
        <section className="py-16 px-6 bg-[#fdfaf6]">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((category) => (
              <Link key={category.id} href={`/creativeAndHandcrafted/coir-products/${category.slug}`}>
                <motion.div
