...
export default function CoirProductDetailPage() {
  ...
  const handleWhatsAppOrder = () => {
    if (product) {
      const productUrl = `${window.location.origin}/creativeAndHandcrafted/coir-products/product/${product.id}`;
      ...
      <section className="relative px-4 sm:px-6 py-8 sm:py-12 bg-[#fdfaf6] min-h-screen">
        <div className="relative max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
            ...
            {/* LEFT - Product Images */}
            <div className="flex flex-col gap-4 sticky top-24 z-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6">
                {relatedProducts.map(relatedProduct => (
                  <a
                    ...
                    href={`/creativeAndHandcrafted/coir-products/product/${relatedProduct.id}`}
