...
export default function SageCategoryPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const res = await fetch(`/api/sage?category=${slug}`);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-700">
              Sacred items for spiritual cleansing and divine blessings
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {products.map((p) => {
                ...
                return (
                  ...
                  >
                    {/* IMAGE - Clickable */}
                    <Link href={`/crystalsAndSpiritual/sage/product/${p.id}`} className="block">
