...
export default function ThakurJiCategoryPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const res = await fetch(`/api/thakur-ji-dresses?category=${slug}`);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-700">
              Divine collection for your spiritual practices
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {products.map((p) => {
                ...
                return (
                  ...
                  >
                    {/* IMAGE - Clickable */}
                    <Link href={`/crystalsAndSpiritual/thakur-ji-dresses/product/${p.id}`} className="block">
                    ...
                    {/* TITLE - Clickable */}
                    <Link href={`/crystalsAndSpiritual/thakur-ji-dresses/product/${p.id}`}>
